...
export const resources = {
  en: {
    translation: {
      ...
      auth: {
        https: {
          description: "Enter credentials to continue the Git operation.",
          host: "Host",
          hostScope: "Use for this host",
          invalidMessage: "Token invalid or expired. Enter a new token.",
          invalidTitle: "Update HTTPS credentials",
          pathScope: "Only this path",
      ...
      settings: {
        ...
        general: {
          ...
          credentialTokenUnchanged:
            "Leave token empty to keep the existing saved token.",
        ...
        status: {
          ...
          credentialTokenRequired: "Enter a token for a new credential.",
  ...
  "zh-CN": {
    translation: {
      ...
      auth: {
        https: {
          description: "输入凭据以继续当前 Git 操作。",
          host: "主机",
          hostScope: "用于此主机",
          invalidMessage: "Token 无效或已过期。请输入新的 Token。",
          invalidTitle: "更新 HTTPS 凭据",
          pathScope: "仅此路径",
          saveScope: "保存范围",
          submit: "继续",
          title: "需要 HTTPS 凭据",
      ...
      settings: {
        ...
        general: {
          ...
          credentialScope: "范围",
          credentialToken: "Token",
          credentialTokenUnchanged: "Token 留空将保留现有已保存 Token。",
        ...
        status: {
          ...
          credentialPathRequired: "路径覆盖需要填写仓库路径。",
          credentialRemoveArmed: "再次选择该凭据即可忘记。",
          credentialSaved: "凭据已保存",
          credentialTokenRequired: "新增凭据需要填写 Token。",
